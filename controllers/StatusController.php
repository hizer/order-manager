...
class StatusController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','admin','delete','statusUpdateAjax','view'),
				'users'=>array('@'),
			),
    ...
    public function actionStatusUpdateAjax()
    {
        $id = Yii::app()->getRequest()->getParam('id');
        $status_id = Yii::app()->getRequest()->getParam('status_id');
        $getModel = Yii::app()->getRequest()->getParam('getModel');
        /*$model=$getModel::model()->findByPk($id);
        /echo $getModel;
        echo "<pre>";
        print_r($model);
        echo "</pre>";
