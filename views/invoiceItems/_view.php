...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('invoice_item_id')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->invoice_item_id), array('view', 'id'=>$data->invoice_item_id)); ?>
	<br />
