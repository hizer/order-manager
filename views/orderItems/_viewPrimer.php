...
$updated = CHtml::encode(Yii::app()->dateFormatter->format("dd-MM-y", $data->primer_updated));
if( $data->isNewUpdateDate($updated, $type.'Updated')){
}else{
	if(Yii::app()->params[$type] != "0000-00-00 00:00:00"){
		
		$updated = CHtml::encode(Yii::app()->dateFormatter->format("y-MM-dd", $data->primer_updated));
		echo "<tr><td colspan='4' ><strong>   ";
		echo CHtml::encode(Yii::app()->dateFormatter->format("dd-MM-y", $data->primer_updated));
		echo "<td><strong> ";
...
<td>
	...
	<?php echo CHtml::encode(Yii::app()->dateFormatter->format("HH:mm:ss", $data->primer_updated)); ?> 
</td>
<td>
