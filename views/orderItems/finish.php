...
echo CHtml::ajaxLink(
	...
	array(
		...
		'success' => 'function(data){
						...
						$("#tables").text(Number((data[0].types[1])).toLocaleString()); 
						$("#chairs").text(Number((data[0].types[2])).toLocaleString()); 
						$("#taburets").text(Number((data[0].types[3])).toLocaleString()); 
...
<div id="print">
	 <div style="text-align: center;">
		<h3 class="d-none">Мебель під фінішом</h3>
		<h4 id="selected-period" class="d-none"></h4>
	</div>
	<table border="0" style="margin: 20px 0">
	<tr>
	<td>Всього товарів: </td><td> <i class="fa fa-spinner  fa-spin fa-fw" style="display:none;" ></i><strong class="value" id="totalAmout"></strong> </td>
	<tr>
	</tr>
	<td>Столів: </td><td> <i class="fa fa-spinner  fa-spin fa-fw" style="display:none;" ></i><strong class="value" id="tables"></strong> </td>
	<tr>
	</tr>
	<td>Стільців: </td><td> <i class="fa fa-spinner  fa-spin fa-fw" style="display:none;" ></i><strong class="value" id="chairs"></strong> </td>
	<tr>
	</tr>
	<td>Табуретів: </td><td> <i class="fa fa-spinner  fa-spin fa-fw" style="display:none;" ></i><strong class="value" id="taburets"></strong> </td>
	</tr>
	</table>
...
<div  class="grid-view">
	<div class="d-table items" >
		<div class="d-table-row-header table-header">
			<div class="d-table-cell"><?php echo CHtml::encode($data->getAttributeLabel('finish_updated')); ?>
			</div>
