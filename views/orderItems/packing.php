...
<table class="items" >
	<tr>
		<th><?php echo CHtml::encode($data->getAttributeLabel('packing_updated')); ?>
		</th>
		...
		<th><?php echo CHtml::encode($data->getAttributeLabel('shop_search')); ?>
		</th>
		
		<th><?php echo CHtml::encode($data->getAttributeLabel('customer_search')); ?>
		</th>
