...
<div class="view">
	...
	<?php echo CHtml::encode($data->customers->first_name); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('payment_name_id')); ?>:</b>
	<?php echo CHtml::encode($data->paymentMethod->payment_method_name);  ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('shipment_name_id')); ?>:</b>
    <?php echo CHtml::encode($data->shipmentMethod->shipment_name);  ?>
	<br />
