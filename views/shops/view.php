...
?>
    ...
    <h1>Замовлення магазину <?php echo $model->full_name; ?></h1>
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
        ...
        'columns'=>array(
			...
			array(
              'name'=>'packing',
                'type'=>'raw',
				'value'=> '$data->packing != 0 ? "<i class=\"fa fa-check-square text-green\" aria-hidden=\"true\"></i>" : "<i class=\"fa fa-minus-square\" aria-hidden=\"true\"></i>"',
            ),
            array(
                'name'=>'product_id',
                'type'=>'raw',
